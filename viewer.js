...
// ===== File Info toggle =====
infoBtn.onclick = () => {
  fileInfoPanel.classList.toggle("show");
  overlay.classList.toggle("show");
};
closeInfoBtn.onclick = () => {
  fileInfoPanel.classList.remove("show");
...
function showUpdatePopup() {
  ...
  popup.innerHTML = `
    <div style="background:#222; padding:20px; border-radius:10px; color:#fff; text-align:center; max-width:300px;">
      <p>Your version is outdated, update now!</p>
      <button id="update-ok">OK</button>
